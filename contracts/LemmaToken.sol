    ...
    Ownable
{
        ...
        returns (uint256 tokenId)
    {
        ...
        require(lemmaValid(_lemma), "LemmaToken: lemma is invalid. Does it contain invalid characters?");
        tokenId = getTokenId(_lemma);
        _safeMint(msg.sender, tokenId);
        return tokenId;
    }

    function define(uint256 tokenId, string calldata text) public whenNotPaused {
